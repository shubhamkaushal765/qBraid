...
from qbraid.transpiler_c.annotations import requires_extras, weight
from qbraid.transpiler_c.conversions.braket import braket_to_cirq
from qbraid.transpiler_c.edge import Conversion
...
def test_requires_extras_appends_dependency():
    ...
    """
    print(getattr(dummy_func, "requires_extras"))
